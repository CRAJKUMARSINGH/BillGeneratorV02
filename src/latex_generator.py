...
\begin{center}
    ...
    \large\textbf{Infrastructure Project Bill}\\[0.3cm]
    \normalsize An Initiative by Mrs. Premlata Jain, Additional Administrative Officer, PWD, Udaipur
\end{center}
...
\begin{center}
\textit{Generated on: \VAR{current_date|date}}\\
\textit{Professional Infrastructure Billing System v3.0}
\end{center}
